...
class TestUser:
    ...
    def test_reading_a_book(self):
        ...
        assert str(user.books_read) == "[<Book Harry Potter, book id = 874658>, <Book Lord of the Rings, book id = 89576>]"
...
class TestBooksJSONReader:
    ...
    def test_books_read_from_file(self, books_read_and_authors):
        dataset_of_books = books_read_and_authors
    ...
    def test_books_read_from_file_and_check_authors(self, books_read_and_authors):
        dataset_of_books = books_read_and_authors
    ...
    def test_books_read_from_file_and_check_other_attributes(self, books_read_and_authors):
        dataset_of_books = books_read_and_authors
    ...
    def test_books_read_from_file_special_characters(self, books_read_and_authors):
        dataset_of_books = books_read_and_authors
        assert dataset_of_books[17].title == "續．星守犬"

    ######################### simon:tests ##########################
    def test_books_read_from_file_and_check_added_attributes(self, books_read_and_authors):
        dataset_of_books = books_read_and_authors
...
class TestBooksInventory:
    ...
    def test_books_inventory_from_json_file(self, books_read_and_authors):
        dataset_of_books = books_read_and_authors
